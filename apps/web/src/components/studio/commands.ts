...
export const studioCommands: PaletteCommand[] = [
  ...
  },
  {
    id: "studio.generate",
    title: "Checkpoints",
    subtitle: "Choose where the agent should pause",
    keywords: ["start run", "approval", "pause", "stops", "automation"],
    run: go(studioPath({ step: "generate" })),
  },
  {
    id: "studio.captions",
    title: "Captions",
    subtitle: "Footage output preference",
  ...
  },
  {
    ...
    subtitle: "Choose where the agent should stop",
    keywords: ["approve", "gate", "manual review", "pause", "stops"],
    run: go(studioPath({ step: "generate" })),
  },
  {
